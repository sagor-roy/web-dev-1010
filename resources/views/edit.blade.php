          ...
          <div class="card card-body">
            ...
            <form action="{{route('update',$data->id)}}" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="number" name="roll" value="{{$data->roll}}" class="form-control" placeholder="Enter your roll">
              </div>
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Email</label>
                <input type="email" name="email" value="{{$data->email}}" class="form-control" placeholder="Enter your email">
              </div>
